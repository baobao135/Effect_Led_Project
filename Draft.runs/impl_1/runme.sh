...
HD_PWD='D:/BKU/HK241/Logic_Design_Project/Draftv1.1/Effect_Led_Project/Draft.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log EffectLed.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source EffectLed.tcl -notrace
